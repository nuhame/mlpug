...
if is_first_worker:
    callbacks += [
        ...
        mlp.callbacks.CheckpointManager(metric_to_monitor='validation.mean.loss',
        ...
        mlp.callbacks.Tensorboard(['duration.mean.batch'],
                                  experiment_name=experiment_name,
                                  dataset_name='training_params',
        ...
        mlp.callbacks.Tensorboard(['duration.epoch'],
                                  experiment_name=experiment_name,
                                  dataset_name='training_params',
                                  batch_level=False,
                                  metric_names=metric_names,
